  ...
  return (
    <div>
      <div class="w-auto  h-132 p-4 bg-black border border-gray-200 rounded-3xl shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700" data-aos="fade-up">
        ...
        <button
          type="button"
          class="text-white bg-indigo-500 hover:shadow-xl hover:shadow-indigo-500/50  w-32 font-normal hover: font-semibold focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center"
        >
          Get Started
        </button>
      </div>
